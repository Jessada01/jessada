    ...
    <div class="container">
        <div class="container-fluid">
            <div class="card">
                ...
                <div class="card-body">
                    <!--  -->
                    @if(Session::has('activity_updated'))
                    <div class="alert alert-success" role="alert">
                        {{Session::get('activity_updated')}}   
                    </div>
                    @endif
                    <form action="{{route('activity.update')}}" method="post" enctype="multipart/form-data">
                        ...
                        <div class="from-group">
                            ...
                            <img src="{{asset('image/activity')}}/{{$activity->imgname}}" id="previewImg" class="img-fluid img-thumbnail" alt="Sheep" width="250" height="auto">
                        </div>
                        <br>
